...
if __name__ == '__main__':
    ...
    dilate_iterations_range = range(6, 10)
    ...
    for dilate_iter in dilate_iterations_range:
        ...
        for erode_iter in erode_iterations_range:
            ...
            for closing_iter in closing_iterations_range:
                # Closing
                ...
                # Check if current text count is better than the best one
                if text_count > best_text_count:
                    best_text_count = text_count
                    best_text = text
                    best_dilate_iterations = dilate_iter
                    best_erode_iterations = erode_iter
                    best_closing_iterations = closing_iter
